...
EXEC my_new_job_proc('JOB3', 'test job3', 7777,10000);
...
EXEC my_new_job_proc('JOB3', 'test job3', 30000, 40000);
...
BEGIN
    ...
    -- p_var1 := '결과1';  IN으로 선언한 변수는 값 할당 자체가 불가하다.
    p_var2 := '결과2';
    p_var3 := '결과3';
...
EXCEPTION 
    WHEN ZERO_DIVIDE THEN
        dbms_output.put_line('5252! 0으로 나눌 수 없다구');
