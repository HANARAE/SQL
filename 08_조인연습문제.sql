...
조건)employee_id가 200인 사람의 이름, department_name을 출력하세요
...
*/
SELECT e.first_name || ' ' || e.last_name AS name, j.job_id, j.job_title
FROM employees e
JOIN jobs j
...
*/
SELECT e1.first_name AS 직원, e1.manager_id AS 매니저id, e2.first_name AS 매니저이름, e2.salary
FROM employees e1
