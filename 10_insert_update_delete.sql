...
ROLLBACK; -- 실행 지점을 다시 뒤로 되돌리는 키워드

-- INSERT의 두번째 방법 (직접 컬럼을 지정하고 저장, NOT NULL 확인)
INSERT INTO departments
...
-- WHERE절에 false값(1=2)을 지정하면 -> 테이블의 구조만 복사하고 데이터는 복사 X
...
-- UPDATE를 진행할 때는 누구룰 수정할 지 잘 지목해야 한다.
